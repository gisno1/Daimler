...
def main():
    ...
    if uploaded_file is not None:
        ...
        st.download_button(label='Download het Excel bestand', data=output, file_name=f'{kenteken} 3.xlsx', mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
